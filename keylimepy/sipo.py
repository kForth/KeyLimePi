...
class SIPO:
   ...
   SN74HC595 SIPO (Serial In Parallel Out) shift
   registers.
   ...
   def __init__(self, pi, SH_LD, SPI_device=SPI.MAIN, chips=1):
      ...
      chips is the number of SN74HC595 being used (defaults
      to 1).
      """
   ...
   def write(self, data):
      ...
      with self._lock:
         ...
         self._pi.spi_write(self._h, data)
      return data
...
if __name__ == "__main__":
   ...
   sr = SIPO(pi, SH_LD=16, SPI_device=SIPO.SPI.AUX, chips=2)
